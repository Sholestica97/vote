...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id_admin FROM users WHERE username = ?";
    ...
    if(empty(trim($_POST["email"]))){
        ...
        // Prepare a select statement
        $sql = "SELECT id_admin FROM users WHERE email = ?";
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group" style="text-align:center">
                <input type="submit" class="btn btn-primary" style="text-align:center" value="Submit">
                <input type="reset" class="btn btn-secondary ml-2" style="text-align:center" value="Reset">
            </div>
